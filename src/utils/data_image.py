...
input_directory = (
    "path to your dataset folder"  # Change this to the folder containing your .hdf5 files
)
output_directory = (
    "path to your output folder"  # Change this to the folder where you want to save the videos
)
