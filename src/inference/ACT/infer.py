...
def eval_bc(config, ckpt_name):
    ...
    try:
        ...
        for i in range(len(image_history)):
            ...
            video_writer = cv2.VideoWriter(os.path.join(save_path, f"video_{i}.mp4"), cv2.VideoWriter_fourcc(*'mp4v'), 20, (640, 360))
        ...
        for i in range(len(qpos_history)):
            ...
            with open(qpos_path, "w", newline="") as file:
                ...
                writer.writerow(['joint_0', 'joint_1', 'joint_2', 'joint_3', 'joint_4', 'joint_5', 'joint_6', 'gripper width'])
