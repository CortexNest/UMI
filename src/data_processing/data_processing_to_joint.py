    ...
    with h5py.File(input_file, 'r') as f_in:
        ...
        for i in range(len(data)):
            ...
            if i == 0:
                ...
                full_joint_angles = cartesian_to_joints(direction, q, initial_joint_angles)
            else:
                full_joint_angles = cartesian_to_joints(direction, q, initial_joint_angles)
            initial_joint_angles = full_joint_angles
            seven_dof_joint_angles = full_joint_angles[1:]
            joint_angles.append(np.rad2deg(seven_dof_joint_angles))
